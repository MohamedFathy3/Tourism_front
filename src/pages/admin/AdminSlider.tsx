...
// src/pages/admin/AdminSlider.tsx
import { useAdminResource } from "@/hooks/admin";
import { sliderAdminService } from "@/services/admin";
...
const AdminSlider = () => {
  ...
  return (
    <>
      <AdminTable
        data={sliders}
        columns={TableConfigs.slider.columns}
        actions={actions}
        loading={loading}
        error={error}
        onRefresh={refresh}
        onAdd={handleAdd}
        addLabel={lang === 'ar' ? 'إضافة سلايدر' : 'Add Slider'}
